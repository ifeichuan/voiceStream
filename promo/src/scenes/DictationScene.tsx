...
export const DictationScene: React.FC = () => {
  ...
  const rawText = '嗯那个我想说一下就是明天的会议改到下午三点了 然后地点还是在三楼会议室';
  const cleanText = '明天的会议改到下午三点了，地点还是在三楼会议室';
    ...
    <AbsoluteFill style={{
      ...
      <div style={{
        ...
        <RemotionShaderOrb
          ...
          audioLevel={frame < 70
            ? interpolate(frame, [10, 25, 45, 65], [0, 0.7, 0.5, 0.8], {extrapolateRight: 'clamp'})
            : 0
          }
        />
      </div>
